//stolen from https://raw.githubusercontent.com/keith/contacts-cli/master/Sources/main.swift
import AddressBook
...
for person in found {
	...
	//let addressesProperty = person.value(forProperty: kABAddressProperty) as? ABMultiValue
	//if let addresses = addressesProperty {
	//	for i in 0..<addresses.count() {
	//		let address = addresses.value(at: i) as? String ?? ""
	//		print(address)
	//	}
	//}
